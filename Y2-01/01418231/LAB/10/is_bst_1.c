...
int main(void)
{
    ...
    else
    {
        ...
        // if ((last_returned = insert_node(in1, tmp_node, in3[0] == 'R')) == 1)
        // {
        //     printf("%s\n", DUP_NODE);

        //     return 0;
        // }
        // else if (last_returned == -1)
        // {
        //     printf("%s\n", INVALID_TREE);
           ...
           && strncmp(in3, "end", STR_LEN))
    {
        ...
        *in3 = '\0';
        ...
        // else if ((last_returned = insert_node(in1, tmp_node, in3[0] == 'R')) == 1)
        // {
        //     // printf("%s\n", DUP_NODE);
...
node *find_node(node *head, const int node_val)
{
    ...
    // if (head == NULL)
    //     return NULL;
    // else if (head->value == node_val)
    //     return head;

    // if (head = find_node(head->left_c, node_val))
    //     return head;

    // if (head = find_node(head->right_c, node_val))
    //     return head;

    // return NULL;

    // while (head->value != node_val && head->left_c != NULL)
    // {
    //     head = head->left_c;
    // }
    ...
    // while (head->value != node_val && head->right_c != NULL)
    // {
    //     head = head->right_c;
    // }
